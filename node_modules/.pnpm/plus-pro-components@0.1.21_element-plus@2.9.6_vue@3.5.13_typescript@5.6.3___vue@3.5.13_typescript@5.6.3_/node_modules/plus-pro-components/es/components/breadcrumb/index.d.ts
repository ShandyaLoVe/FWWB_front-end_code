...
export declare const PlusBreadcrumb: {
    ...
    $slots: {
        "breadcrumb-item-title"?(_: {
            ...
            meta: RouteMeta;
            props: Record<string, boolean | Record<string, any> | ((to: RouteLocationNormalized) => Record<string, any>)>;
            beforeEnter: NavigationGuardWithThis<undefined> | NavigationGuardWithThis<undefined>[] | undefined;
            leaveGuards: Set< NavigationGuard> & Omit<Set< NavigationGuard>, keyof Set<any>>;
            updateGuards: Set< NavigationGuard> & Omit<Set< NavigationGuard>, keyof Set<any>>;
            enterCallbacks: Record<string, ((vm: ComponentPublicInstance) => any)[]>;
            instances: Record<string, ComponentPublicInstance | null | undefined>;
            aliasOf: {
                path: string;
                redirect: string | ((to: RouteLocation) => RouteLocationRaw) | {
                    query?: LocationQueryRaw | undefined;
