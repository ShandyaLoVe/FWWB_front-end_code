                    ...
                    return openBlock(), createBlock(
                      ...
                      }, item.colProps || _ctx.colProps),
                      {
                        default: withCtx(() => [
                          ...
                          item.renderExtra || _ctx.$slots[unref(getExtraSlotName)(item.prop)] ? (openBlock(), createElementBlock("div", _hoisted_1$e, [
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(ElPopover), mergeProps({
        ...
        default: withCtx(() => [
          renderSlot(_ctx.$slots, "default"),
          _ctx.hasShowBottomButton ? (openBlock(), createElementBlock("div", _hoisted_1$9, [
            createVNode(unref(ElButton), {
              size: "small",
              plain: "",
        ...
        default: withCtx(() => [
          ...
          createVNode(unref(ElContainer), { class: "plus-layout-main-wrapper" }, {
            default: withCtx(() => [
              ...
              createElementVNode("main", _hoisted_1$2, [
                createCommentVNode(" \u9762\u5305\u5C51\u4E0A\u65B9 "),
                _ctx.$slots["layout-extra"] ? (openBlock(), createElementBlock("div", _hoisted_2$1, [
...
export { DatePickerValueIsArrayList, DefaultPageInfo, DefaultPageSizeList, PlusBreadcrumb, PlusCheckCard, PlusCheckCardGroup, PlusDatePicker, PlusDescriptions, PlusDialog, PlusDialogForm, PlusDisplayItem, PlusDrawerForm, PlusForm, PlusFormItem, PlusHeader, PlusInputTag, PlusLayout, PlusPage, PlusPagination, PlusPopover, PlusRadio, PlusSearch, PlusSidebar, PlusSidebarItem, PlusStepsForm, PlusTable, TableFormFieldRefInjectionKey, TableFormRefInjectionKey, TableFormRowInfoInjectionKey, ValueIsArrayList, ValueIsBooleanList, ValueIsNumberList, buildLocaleContext, buildTranslator, installer as default, getOptionsByOptionsMap, install, translate, useGetOptions, useLocale, useTable, version };
