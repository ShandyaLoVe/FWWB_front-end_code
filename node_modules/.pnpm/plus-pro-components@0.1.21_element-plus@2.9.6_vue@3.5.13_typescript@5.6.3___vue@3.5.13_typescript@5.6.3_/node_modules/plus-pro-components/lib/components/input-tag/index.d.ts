...
import { Mutable } from 'plus-pro-components';
import { DefineComponent, PropType, Ref, CreateComponentPublicInstance, ExtractPropTypes, Component, ComputedOptions, MethodOptions, CSSProperties, StyleValue, Slot, ComputedRef, ShallowRef, ComponentOptionsMixin, VNodeProps, AllowedComponentProps, ComponentCustomProps, PublicProps } from 'vue';
...
export declare const PlusInputTag: DefineComponent<{
    ...
    tagProps: {
        type: PropType<Partial< Mutable<TagProps>>>;
        default: () => {};
    };
    limit: {
