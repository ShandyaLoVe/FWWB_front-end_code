...
import { PlusSidebarProps, PlusHeaderProps, PlusBreadcrumbProps } from 'plus-pro-components';
import { ScrollbarProps, BacktopProps, MenuItemClicked } from 'element-plus';
import { Mutable, PlusRouteRecordRaw, RenderTypes } from 'plus-pro-components';
import { CreateComponentPublicInstance, ExtractPropTypes, PropType, Ref, ComponentInternalInstance, ComputedRef, VNodeProps, AllowedComponentProps, ComponentCustomProps, Slot, ComponentPublicInstance, ComponentOptionsBase, Component, ComputedOptions, MethodOptions, VNode, RendererNode, RendererElement, ComponentOptionsMixin, DebuggerEvent, nextTick, WatchOptions, WatchStopHandle, ShallowUnwrapRef, ComponentCustomProperties } from 'vue';
...
export declare const PlusLayout: {
    new (...args: any[]): CreateComponentPublicInstance<Readonly< ExtractPropTypes<{
        ...
        backtop: {
            type: PropType<boolean | Partial< Mutable<BacktopProps>>>;
            default: boolean;
        };
    }>>, {
